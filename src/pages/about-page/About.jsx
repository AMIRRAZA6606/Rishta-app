        ...
        <div className='about-main-con'>
            ...
            <div className="banner3-main">
                ...
                <div className="banner3-text">
                    ...
                    <p className='benner3-para'>
                        ...
                        Your trust is our top priority! All matrimonial profiles on Dil Ka Rishta are 100% verified via phone and in person verification.
                    </p>
                </div>
            ...
            <div className="banner5-main">
                ...
                <div className="banner5-text">
                    <p className='para1'>In today's world, finding a partner can be difficult. There are so many options for singles to choose from and they all seem alike!
                        That is why Rishta.com was founded with the goal of making your search easier  we want you to find happiness.</p>
                    <p className='para2'>Rishta.com is Pakistan's No.1 Matchmaking Service, founded with a simple objective - to help people find happiness and love in
                        their lives. Rishta.com has helped more than a million Pakistani couples marry each other</p>
                </div>
