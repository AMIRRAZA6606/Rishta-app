                            ...
                            <>
                                <div className='user-con'>
                                    <div className='user-img'>
                                        ...
                                        {
                                            obj.isOnline &&
                                            <span className='isOnine'></span>
                                        }
                                    </div>
                                    <div className='user-details-con'>
                                        <div className='user-name-div'>
                                            <div className='name'>
                                                {obj?.isPinChat && <img src={archieveIcon}
                                                    alt="" />}
                                        ...
                                        <div className='last-message'>
                                            {
                                                obj?.isTyping ? <p className='typing'>typing...</p> :
                                                    <>
                                                        <p>{obj?.lastMessage}</p>
                                                        {
                                                            obj?.messageStatus === "delivered" ? <img src={messageDeliverIcon} alt="" /> : <img src={messageSeenIcon} alt="" />
                    ...
                    <div className='chat'>
                        {
                            chatMessages.map((msg) => {
                                return (
                                    <>
                                        <div className='chat-message' style={{ alignSelf: `${msg?.sender ? "flex-end" : "flex-start"}` }}>

                                            {msg?.receiver && <img src={msg?.profileImg} alt="" />}
                                            <div className='message'>
                                                <p>{msg?.message}</p>
                                                <div className='message-time' style={{ justifyContent: `${msg?.sender ? "flex-end" : "flex-start"}` }}>
                                                    {
                                                        msg?.sender && (
                                                            <>
                                                                {
                                                                    ...
                                                                    msg?.isDelivered && <img src={messageDeliverIcon} alt="" />
                                                                }
                                                            </>
                                                        )
                                                    }
